...
System::System(const string &strVocFile, const string &strSettingsFile,
               const eSensor sensor, const bool bUseViewer, const bool bReuse)
    : mSensor(sensor), mbReset(false), mbActivateLocalizationMode(bReuse),
  ...
  mpTracker =
      new Tracking(this, mpVocabulary, mpFrameDrawer, mpMapDrawer, mpMap,
                   mpKeyFrameDatabase, strSettingsFile, mSensor, bReuse);
...
Map *System::GetMap() { return mpMap; }
